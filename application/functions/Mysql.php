 ...
 * author:JiaoJinYing (252469550@qq.com)
 * lastmodify:2015.6.23
 */
final class mysql {
	 ...
	 * config array include such as flow:
	 * hostname server db host adress
	 * pconnect 1  mysql_pconnect the other mysql_connect
	 * username
	 * password
	 * charset 编码 such as  utf8 gbk gb2312 binary 默认是utf8
	 * database
	 * @return void
	 */
	 ...
	 * @return array		查询结果集数组
	 */
	public function query_select($sql,$key = ''){
	   $this->execute($sql);
		if(!is_resource($this->lastqueryid)) {
			return $this->lastqueryid;
		}
